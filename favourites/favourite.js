...
// Event listener attached and will be executed when the page is loaded
window.addEventListener("load", function () {
     // Getting the favourites array fom localStorage
     let favourites = localStorage.getItem("favouriteCharacters");

     // if favourites is null the we display nothing and return here and else if it is not null then it converts it to array
     if (favourites == null) {
     ...
     // if all the characters are deleted from favourites and when no characters are left to display
     ...
     cardContainer.innerHTML = "";
          ...
          cardContainer.innerHTML +=
               ...
               <div class="flex-col card">
                    ...
                    <button class="btn remove-btn"><i class="fa-solid fa-heart-crack"></i> &nbsp; Remove from Favourites</button>
               </div>
          `
...
function removeCharacterFromFavourites() {
     ...
     // favouritesCharacterIDs is taken and deleting the ID of the character which is deleted from favourites
     ...
     // deleting the character from array and whose id is matching
